...
const ChatContentDetails = ({ selectedChat }) => {
    ...
    return (<PerfectScrollbar className="px-4 py-4 h-100">
      {selectedChat.conversion?.map((conversion, idx) => (<div key={idx} className="w-100">
          {conversion.replyMessage && (<div className="d-flex align-items-start flex-row-reverse gap-3 mb-12 ms-auto" style={{ maxWidth: '400px' }}>
          ...
          {conversion.sentMessage && (<div className="d-flex align-items-start gap-3 mb-12" style={{ maxWidth: '400px' }}>
