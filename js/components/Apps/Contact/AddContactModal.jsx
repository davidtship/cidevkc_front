    ...
    return (<>
      <Modal show={show} onHide={onHide} centered>
        ...
        <Modal.Body>
          <Form noValidate id="addContactForm" validated={validated} onSubmit={handleAddContact}>
            ...
            cursor: 'pointer',
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="text" name="firstname" onChange={handleInputChange} required isInvalid={validated && !formData.firstname} placeholder="First Name...."/>
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="text" name="lastname" onChange={handleInputChange} required isInvalid={validated && !formData.lastname} placeholder="Last Name...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="tel" name="phone" onChange={handleInputChange} required isInvalid={validated && !formData.phone} placeholder="Phone...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="text" name="role" onChange={handleInputChange} required isInvalid={validated && !formData.role} placeholder="Role...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="text" name="location" onChange={handleInputChange} required isInvalid={validated && !formData.location} placeholder="Location...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={6}>
                <Form.Group>
                  <Form.Control type="url" name="website" onChange={handleInputChange} required isInvalid={validated && !formData.website} placeholder="Website...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={12}>
                <Form.Group>
                  <Form.Control as="textarea" rows={3} name="about" onChange={handleInputChange} required isInvalid={validated && !formData.about} placeholder="About...."/>
                  <Form.Control.Feedback type="invalid">
              ...
              <Col lg={12}>
                <Form.Group>
                  <Form.Control as="textarea" rows={3} name="message" onChange={handleInputChange} placeholder="Message...."/>
                  <Form.Control.Feedback type="invalid">
        ...
        <Modal.Footer>
          ...
          <Button variant="primary" onClick={handleAddContact} className={`text-white ${loading ? 'disabled' : ''}`} disabled={loading}>
            {loading ? (<>
