...
const InvoiceCreateContent = ({ handleSendClick, setSelectedInvoice, setShowInvoiceCreate, sidebarLeftToggle, setSidebarLeftToggle, }) => {
    ...
    return (<>
      <Stack direction="horizontal" gap={3} className="px-3 border-bottom justify-content-between bg-body-tertiary" style={{ minHeight: '4.5rem' }}>
        ...
        <Button variant="light" className="btn-icon btn-md ms-auto d-none d-lg-flex" onClick={handleSidebarLeftToggle}>
            ...
            <Row className="g-4 mb-4">
              <Col md={4}>
                ...
                <InputGroup>
                  ...
                  <InputMask mask="999999" maskChar={null} className="form-control" placeholder="Invoice number...."/>
                </InputGroup>
              </Col>
              <Col md={4}>
                <Form.Group controlId="exampleForm.ControlInputIssueDate">
                  ...
                  <Flatpickr options={{
            dateFormat: 'Y-m-d',
        }} placeholder="Issue date..." className="form-control"/>
                </Form.Group>
              </Col>
              <Col md={4}>
                <Form.Group controlId="exampleForm.ControlInputDueDate">
                  ...
                  <Flatpickr options={{
            dateFormat: 'Y-m-d',
        }} placeholder="Due date..." className="form-control"/>
                </Form.Group>
              </Col>
            </Row>
          </div>
            ...
            <Table bordered responsive>
              ...
              <tbody>
                {items.map((item) => (<tr key={item.id}>
                    <td>{item.id}</td>
                    <td>
                      <Form.Control type="text" name="" placeholder="Enter product name...." value={item.name} onChange={(e) => handleInputChange(item.id, 'name', e.target.value)}/>
                    </td>
                    <td>
                      <Form.Control type="number" name="" placeholder="Qty" value={item.qty} onChange={(e) => handleInputChange(item.id, 'qty', e.target.value)}/>
                    </td>
                    <td>
                      <Form.Control type="number" name="" placeholder="Price" value={item.unitPrice} onChange={(e) => handleInputChange(item.id, 'unitPrice', e.target.value)}/>
                    </td>
              ...
              <div className="px-4 px-md-6 py-4 py-md-8 bg-secondary-subtle rounded-3 ms-auto">
                <div className="mb-8">
                  ...
                  <Form.Check type="switch" id="check-api-client-notes" className="mb-4">
                    <Form.Check.Input onChange={(e) => handleToggleClientNotes(e.target.checked)} defaultChecked/>
                    <Form.Check.Label className="ms-2">
