      ...
      <Offcanvas show={showSendOptions} onHide={handleCloseSendOptions} placement="end">
        ...
        <Offcanvas.Body>
          <Form.Group className="mb-6" controlId="exampleForm.ControlInputFrom">
            ...
            <Form.Control type="text" placeholder="Invoice number" disabled readOnly defaultValue="#INV-987456"/>
          </Form.Group>
          <Form.Group className="mb-6" controlId="exampleForm.ControlInputFrom">
          ...
          <Form.Group className="mb-6" controlId="formTo">
            ...
            <Form.Control type="email" placeholder="Invoice to...." name="to" value={to} onChange={handleInputChange} isInvalid={toError !== ''}/>
            <Form.Control.Feedback type="invalid">{toError}</Form.Control.Feedback>
          </Form.Group>
          <Form.Group className="mb-6" controlId="formSubject">
            <Form.Label>Subject:</Form.Label>
            <Form.Control type="text" placeholder="Subject...." name="subject" value={subject} onChange={handleInputChange} isInvalid={subjectError !== ''}/>
          ...
          <Form.Group className="mb-12" controlId="formMessage">
            ...
            <Form.Control as="textarea" rows={5} placeholder="Message...." name="message" value={message} onChange={handleInputChange} isInvalid={messageError !== ''}/>
            <Form.Control.Feedback type="invalid">{messageError}</Form.Control.Feedback>
          </Form.Group>
          <Stack gap={2} direction="horizontal">
            <Button variant="primary" onClick={handleSendClick} className="text-white w-50" disabled={loading}>
              {loading ? (<>
