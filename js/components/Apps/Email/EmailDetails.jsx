...
const EmailDetails = ({ selectedEmail }) => {
    ...
    return (<>
      <PerfectScrollbar className="px-4 py-4 h-100">
          ...
          <Card.Body>
            ...
            {attachment && (<>
                ...
                <div className="d-grid d-md-flex gap-2">
                  <Link to="" className="d-inline-flex align-items-center gap-3 px-4 py-3 rounded border">
        ...
        {showEditor && (<>
            <ReactQuill value={editorContent} onChange={(content) => setEditorContent(content)} theme="snow" modules={{
                toolbar: [
                    [{ header: [1, 2, false] }],
            ...
            <Stack direction="horizontal" gap={2} className="mt-4">
              <Button variant="primary" onClick={handleSend} className="text-white" disabled={loading}>
                {loading ? (<>
