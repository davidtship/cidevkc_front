...
const EventUpdateModal = ({ show, handleCloseModal, selectedEvent, handleUpdateEvent, }) => {
    ...
    return (<Modal centered show={show} onHide={handleCloseModal}>
      ...
      <Modal.Body>
        <Form>
          ...
          <Form.Group className="mb-4" controlId="formStartTime">
            ...
            <Flatpickr className="form-control" data-enable-time value={formData.startTime || undefined} onChange={(date) => setFormData({
            ...formData,
          ...
          <Form.Group className="mb-4" controlId="formEndTime">
            ...
            <Flatpickr data-enable-time className="form-control" value={formData.endTime || undefined} onChange={(date) => setFormData({
            ...formData,
          ...
          <Form.Group className="mb-0" controlId="formColor">
            ...
            <Select classNamePrefix="select" options={colorOption} value={{ value: formData.color, label: selectedColorLabel }} onChange={(selectedOption) => {
            setFormData({
                ...formData,
