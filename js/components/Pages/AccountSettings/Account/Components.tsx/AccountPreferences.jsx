...
const AccountPreferences = () => {
    return (<>
      ...
      <Row className="g-md-4 mb-6 mb-md-8">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Select options={TimezoneOptions} defaultValue={TimezoneOptions.find((option) => option.value === 'Asia/Tokyo')} classNamePrefix="select"/>
        </Col>
      </Row>
      <Row className="g-md-4 mb-4">
        <Col md={3}>
        ...
        <Col md={9} xl={8} xxl={6}>
          <Select options={LanguageOptions} defaultValue={LanguageOptions.find((option) => option.value === 'en')} classNamePrefix="select"/>
        </Col>
      </Row>
    </>);
};
