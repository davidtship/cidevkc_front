...
const NotificationPush = () => {
    return (<>
      <Row className="g-4">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Form.Check type="radio" name="PushNotify" className="mb-4" id="radio-push-notify-everything" defaultChecked label={<div className="ms-2">
          ...
          <Form.Check type="radio" name="PushNotify" className="mb-4" id="radio-push-notify-important" label={<div className="ms-2">
          ...
          <Form.Check type="radio" name="PushNotify" className="mb-0" id="radio-push-notify-no-push" label={<div className="ms-2">
