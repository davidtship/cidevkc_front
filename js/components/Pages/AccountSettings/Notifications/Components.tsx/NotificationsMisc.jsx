...
const NotificationsMisc = () => {
    return (<>
      <Row className="g-4">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Form.Check type="switch" className="mb-4" id="switch-miscellaneous-enable-sound" defaultChecked label={<div className="ms-2">
          ...
          <Form.Check type="switch" className="mb-4" id="switch-miscellaneous-disable-notify" label={<div className="ms-2">
          ...
          <Form.Check type="switch" className="mb-4" id="switch-miscellaneous-led-notify" label={<div className="ms-2">
          ...
          <Form.Check type="switch" className="mb-0" id="switch-miscellaneous-contact-joining" label={<div className="ms-2">
