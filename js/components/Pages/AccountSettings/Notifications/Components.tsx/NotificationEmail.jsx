    ...
    return (<>
      ...
      <Row className="g-4 mb-6">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            ...
            <Col xs={4}>
              <Form.Check label="Browser" type="checkbox" id="checkbox-browser-conversations-tones" defaultChecked/>
            </Col>
            <Col xs={4}>
      ...
      <Row className="g-4 mb-6">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            <Col xs={4}>
              <Form.Check label="Email" type="checkbox" id="checkbox-email-activity" defaultChecked/>
            </Col>
            <Col xs={4}>
      ...
      <Row className="g-4 mb-6">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            ...
            <Col xs={4}>
              <Form.Check label="Browser" type="checkbox" id="checkbox-browser-payments" defaultChecked/>
            </Col>
            <Col xs={4}>
      ...
      <Row className="g-4 mb-6">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            <Col xs={4}>
              <Form.Check label="Email" type="checkbox" id="checkbox-email-remainders" defaultChecked/>
            </Col>
            <Col xs={4}>
      ...
      <Row className="g-4 mb-6">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            ...
            <Col xs={4}>
              <Form.Check label="Browser" type="checkbox" id="checkbox-browser-daily-summary" defaultChecked/>
            </Col>
            <Col xs={4}>
      ...
      <Row className="g-4 mb-0">
        ...
        <Col md={9} xl={8} xxl={6}>
          <Row className="g-4 mb-4">
            <Col xs={4}>
              <Form.Check label="Email" type="checkbox" id="checkbox-email-news-updates" defaultChecked/>
            </Col>
            <Col xs={4}>
