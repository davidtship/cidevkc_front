...
const avatarSources = [avatar1, avatar2, avatar3, avatar4, avatar5, avatar6, avatar7];
const renderAvatars = (sources) => {
    return sources.map((src, index) => (<Avatar key={index} type="image" src={src} alt={`User Avatar ${index + 1}`} className="avatar avatar-md"/>));
};
              ...
              <div className="d-md-flex align-items-center">
                <div>
                  <Stack direction="horizontal" className="mb-2">
                    ...
                    <div>
                      <Stack direction="horizontal" className="fs-12 px-2 ms-2 border border-success bg-success-subtle rounded-pill">
                        <span className="d-block bg-success rounded-circle" style={{ width: '0.25rem', height: '0.25rem' }}></span>
