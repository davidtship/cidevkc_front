      ...
      <Card className="mb-3 mb-md-4">
        <Card.Body className="py-6 d-md-flex align-items-center">
          <div className="d-flex align-items-center">
            <div className="position-relative flex-shrink-0 me-4" style={{ width: '5rem', height: '5rem' }}>
              ...
              <div className="position-absolute">
                <CircularProgressbar value={50} styles={{
            path: {
                stroke: themeColor,
        ...
        <PerfectScrollbar>
          <Nav activeKey={activeKey} onSelect={handleSelect} variant="pills" defaultActiveKey="/user-profile/overview" className="d-flex flex-row flex-nowrap flex-row px-4 py-3 border-top">
            {AccountSettingsNavs.map((tab, idx) => (<Nav.Item key={idx}>
