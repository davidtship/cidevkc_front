...
const IntegrationsAvaiable = () => {
    ...
    return (<>
      ...
      <Row className="g-3 g-md-4">
        {avaiableData.map((item, idx) => (<Col md={6} xl={4} key={idx}>
            <Card>
              <Card.Body>
                <Stack gap={3} direction="horizontal" className="mb-4">
                  ...
                  <div className="ms-auto">
                    <span className={`fs-12 px-2 ms-2 border rounded-pill hstack ${item.status === 'Verified'
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        ...
        <Modal.Footer>
          ...
          <Button variant="success" className="text-white" onClick={handleInstallModal} disabled={isSaving}>
            {isSaving ? (<>
