...
const TermsServicesContent = () => {
    ...
    return (<>
      {dataTerms.map((item, idx) => (<div className="mb-12" key={idx}>
      ...
      <div className="my-8 my-md-12 my-lg-16">
        ...
        <Stack gap={2} direction="horizontal">
          {isYesButtonVisible && (<Button variant="" className="btn btn-md btn-soft-success rounded-pill" onClick={() => handleButtonClick(true)}>
              <i className="fi fi-rr-social-network"></i>
              <span className="ms-2">Yes!</span>
            </Button>)}
          {isNoButtonVisible && (<Button variant="" className="btn btn-md btn-soft-danger rounded-pill" onClick={() => handleButtonClick(false)}>
      ...
      <hr />
      <Stack gap={1} direction="horizontal" className="mt-8 mt-md-12 mt-lg-16 justify-content-center">
        <Button variant="" className="btn btn-outline-danger rounded-pill" style={{ width: '120px' }} onClick={handleDecline}>
          Decline
        </Button>
        <Button variant="" className="btn btn-success rounded-pill" style={{ width: '120px' }} onClick={handleAccept}>
          Accept
        </Button>
      </Stack>
    </>);
