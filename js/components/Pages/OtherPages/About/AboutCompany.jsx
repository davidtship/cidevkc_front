        ...
        <Col xl={6}>
          ...
          <div className="fw-bold text-dark display-5 lh-base mb-6">
            ...
            <div className="px-2 d-inline-block border border-2 border-primary position-relative">
              ...
              <span className="d-block bg-primary position-absolute" style={{
            width: '0.75rem',
            height: '0.75rem',
            left: '-0.3rem',
            top: '-0.3rem',
          ...
          <Stack direction="horizontal" gap={1}>
            ...
            <Link to="/other-pages/contact-us" className="btn btn-light bg-secondary-subtle border border-secondary border-opacity-10">
              Contact Us
            </Link>
          </Stack>
        </Col>
        <Col xl={6} className="p-0 rounded position-relative">
          <Image src={workingOfficeTogather} alt="Image" className="img-fluid img-thumbnail rounded-3"/>
          <div style={OverlayLayerStyle}>
            <Button variant="" className="bg-light text-dark border border-6 border-secondary-subtle hstack rounded-circle position-absolute top-50 start-50 translate-middle" style={{ width: '5rem', height: '5rem' }}>
