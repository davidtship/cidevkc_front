...
const ContactForm = () => {
    ...
    return (<>
      <Card className="mx-4 mx-md-6 border-0">
        <Card.Body className="p-4 p-md-12 p-lg-16 w-100 mx-auto rounded-5 bg-secondary-subtle z-1 shadow-sm border" style={{ maxWidth: '768px', marginBottom: '-150px' }}>
          <h3>Get in touch</h3>
          ...
          <Form className="mt-12" onSubmit={handleSubmit}>
            <Row className="g-4 mb-4">
              ...
              <Col md={12}>
                ...
                <Form.Control as="textarea" rows={5} name="message" value={formData.message} onChange={handleInputChange}/>
                <div className="fs-12 text-danger">{formErrors.message}</div>
              </Col>
            </Row>
            <Button type="submit" size="lg" className="w-100 text-white" disabled={!isFormValid || isLoading}>
              {isLoading ? (<>
