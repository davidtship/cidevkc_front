...
const GalleryThree = () => {
    ...
    return (<>
      ...
      <Card>
        ...
        <Card.Body>
          <PhotoAlbum photos={dataGalleryThree} layout="masonry" targetRowHeight={200} onClick={({ index }) => setIndex(index)}/>
          <Lightbox slides={dataGalleryThree} open={index >= 0} index={index} close={() => setIndex(-1)} plugins={[Fullscreen, Slideshow, Thumbnails, Zoom, Download, Captions, Counter, Share]}/>
        </Card.Body>
        <Card.Footer>
          <Stack direction="horizontal" gap={2}>
            <span className="fs-13 text-muted">14 Photos</span>
            <span className="d-none d-lg-flex bg-secondary bg-opacity-50 rounded-circle" style={{ width: '0.25rem', height: '0.25rem' }}></span>
