...
const GalleryTwo = () => {
    ...
    return (<>
      ...
      <Card>
        ...
        <Card.Body>
          <PhotoAlbum photos={dataGalleryTwo} layout="masonry" targetRowHeight={200} onClick={({ index }) => setIndex(index)}/>
          <Lightbox slides={dataGalleryTwo} open={index >= 0} index={index} close={() => setIndex(-1)} plugins={[Fullscreen, Slideshow, Thumbnails, Zoom, Download, Captions, Counter, Share]}/>
        </Card.Body>
        <Card.Footer>
