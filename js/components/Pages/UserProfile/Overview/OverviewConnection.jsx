...
const OverviewConnection = () => {
    ...
    return (<>
      ...
      {followerData.map(({ image, name, connection, isFollowing }, idx) => (<Stack key={idx} direction="horizontal" gap={3} className="w-100 mb-4">
          ...
          <Button variant="soft-light" className={`rounded-pill ms-auto ${isFollowing ? 'bg-success-subtle text-success' : ''}`} onClick={() => toggleIsFollow(idx)}>
