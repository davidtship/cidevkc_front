...
const OverviewInterested = () => {
    return (<>
      ...
      <div className="d-flex flex-wrap gap-1">
        ...
        {MoviesData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
      ...
      <div className="d-flex flex-wrap gap-1">
        ...
        {MusicsData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
      <hr style={{ borderStyle: 'dashed' }}/>
      <div className="d-flex flex-wrap gap-1">
        ...
        {BooksData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
      <hr style={{ borderStyle: 'dashed' }}/>
      <div className="d-flex flex-wrap gap-1">
        ...
        {GamesData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
      <hr style={{ borderStyle: 'dashed' }}/>
      <div className="d-flex flex-wrap gap-1">
        ...
        {HobbiesData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
      <hr style={{ borderStyle: 'dashed' }}/>
      <div className="d-flex flex-wrap gap-1">
        ...
        {EpisodesData.map(({ name }, idx) => (<Link key={idx} to="#!" className="py-1 px-2 border border-dashed rounded-pill fs-12">
            {name}
          </Link>))}
      </div>
    </>);
