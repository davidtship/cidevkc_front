...
const CardStretch = () => {
    ...
    return (<Row className="g-3 g-md-4">
      {columnData.map((column, columnIndex) => (<Col lg={4} key={columnIndex}>
          {column.cards.map(({ header, bodyTitle, stretchClass }, cardIndex) => (<Card key={cardIndex} className={stretchClass}>
