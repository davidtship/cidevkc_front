...
const AdvSwitchWithText = () => {
    return (<>
      {switches.map(({ label, className, onText, offText, defaultChecked }, index) => (<React.Fragment key={index}>
          <Form.Check.Label className={className}>
            <Form.Check.Input type="checkbox" className="switch-input" defaultChecked={defaultChecked}/>
