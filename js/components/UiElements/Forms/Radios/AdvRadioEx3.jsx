...
const AdvRadioEx3 = () => {
    return (<Row>
      {paymentMethods.map(({ id, image, title, fee, defaultChecked }) => (<Col lg={4} key={id}>
          <Form.Check.Label htmlFor={id} className="radio-card">
            <Form.Check.Input id={id} type="radio" name="radio-card-example3" defaultChecked={defaultChecked}/>
