...
const AdvRadioEx4 = () => {
    return (<Row>
      {radioCardsData.map(({ id, image, title, price, priceSuffix, description, defaultChecked }) => (<Col lg={4} key={id}>
            <Form.Check.Label htmlFor={id} className="radio-card">
              <Form.Check.Input id={id} type="radio" name="radio-card-example4" defaultChecked={defaultChecked}/>
