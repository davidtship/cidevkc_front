...
const AdvRadioEx2 = () => {
    return (<Row>
      {radioCardsData.map(({ id, title, description, price, defaultChecked }) => (<Col lg={3} key={id}>
          <Form.Check.Label htmlFor={id} className="radio-card">
            <Form.Check.Input id={id} type="radio" name="radio-card-example2" defaultChecked={defaultChecked}/>
