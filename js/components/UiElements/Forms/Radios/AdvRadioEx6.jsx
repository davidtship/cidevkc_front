...
const AdvRadioEx6 = () => {
    return (<Row>
      {cardData.map(({ id, name, company, phone, email, specialization, website, address, defaultChecked }) => (<Col lg={4} key={id}>
            <Form.Check.Label htmlFor={id} className="radio-card">
              <Form.Check.Input id={id} type="radio" name="radio-card-example6" defaultChecked={defaultChecked}/>
