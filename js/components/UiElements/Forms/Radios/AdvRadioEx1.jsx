...
const AdvRadioEx1 = () => {
    return (<Row className="g-3 g-md-4">
      {radioCardsData.map(({ id, title, price, priceSuffix, description, defaultChecked }) => (<Col lg={4} key={id}>
          <Form.Check.Label htmlFor={id} className="radio-card">
            <Form.Check.Input id={id} type="radio" name="radio-card-example1" defaultChecked={defaultChecked}/>
