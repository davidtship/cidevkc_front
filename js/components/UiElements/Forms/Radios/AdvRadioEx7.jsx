...
const AdvRadioEx7 = () => {
    return (<Row>
      {cardData.map(({ id, image, title, desc, price, popular, defaultChecked }) => (<Col lg={4} key={id}>
          <Form.Check.Label htmlFor={id} className="radio-card">
            <Form.Check.Input id={id} type="radio" name="radio-card-example7" defaultChecked={defaultChecked}/>
