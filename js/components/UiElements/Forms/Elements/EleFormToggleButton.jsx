...
const EleFormSolidRadio = () => {
    ...
    return (<>
      <div className="hstack flex-wrap gap-2">
        {checkboxes.map(({ id, label, variant, disabled, defaultChecked }) => (<div key={id} className="form-check ps-0">
            <Form.Control type="checkbox" className="btn-check" id={id} disabled={disabled} defaultChecked={defaultChecked}/>
      ...
      <hr className="my-4"/>
      <div className="hstack flex-wrap gap-2">
        {radioButtons.map(({ id, label, variant, disabled, defaultChecked }) => (<div key={id}>
            <Form.Control type="radio" className="btn-check" name="options" id={id} disabled={disabled} defaultChecked={defaultChecked}/>
