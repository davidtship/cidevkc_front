...
const EleFormSolidCheckbox = () => {
    ...
    return (<Table responsive borderless>
      ...
      <tbody>
        {checkboxes.map(({ id, label, checkedId, checkedDisabledId }) => (<tr key={id}>
            <td>{label}</td>
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-check-${label.toLowerCase()}`} type="checkbox" id={id}/>
            ...
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-check-${label.toLowerCase()}`} type="checkbox" id={checkedId} defaultChecked/>
            ...
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-check-${label.toLowerCase()}`} type="checkbox" id={checkedDisabledId} defaultChecked disabled/>
