    ...
    return (<>
      <Row className="gy-6 gy-sm-8 gy-md-12">
        ...
        <Col xs={12}>
          ...
          <Form.Control type="color" className="form-control-color w-100" id="colorPicker" defaultValue="#364574"/>
        </Col>
        <Col xs={12}>
          <Form.Label htmlFor="borderInput">Input Border Style</Form.Label>
          <Form.Control type="text" id="borderInput" placeholder="Enter your name" style={{ borderStyle: 'dashed' }}/>
        </Col>
        <Col xs={12}>
