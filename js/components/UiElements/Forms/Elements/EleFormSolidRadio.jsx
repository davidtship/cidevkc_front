...
const EleFormSolidRadio = () => {
    ...
    return (<Table responsive borderless>
      ...
      <tbody>
        {radioButtons.map(({ id, name, label, checkedId }) => (<tr key={id}>
            <td>{label}</td>
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-radio-${label.toLowerCase()}`} type="radio" name={name} id={id}/>
            ...
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-radio-${label.toLowerCase()}`} type="radio" name={name} id={checkedId} defaultChecked={!!checkedId}/>
            ...
            <td>
              <div className="form-check mb-4 mb-md-6 mb-lg-8">
                <input className={`form-check-input form-radio-${label.toLowerCase()}`} type="radio" name={name} id={`${id}CheckedDisabled`} disabled/>
