...
const AdvCheckboxEx2 = () => {
    return (<Row>
      {checkboxData.map(({ id, title, desc, price, defaultChecked }) => (<Col lg={3} key={id}>
          <Form.Check.Label htmlFor={id} className="check-card">
            <Form.Check.Input id={id} type="checkbox" name="check-card-example2" defaultChecked={defaultChecked}/>
