...
const AdvCheckboxEx5 = () => {
    return (<Row>
      {checkboxData.map(({ id, iconClass, title, desc, price, defaultChecked, popular }) => (<Col lg={3} key={id}>
          <Form.Check.Label htmlFor={id} className="check-card">
            <Form.Check.Input id={id} type="checkbox" name="check-card-example5" defaultChecked={defaultChecked}/>
