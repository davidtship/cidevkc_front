...
const AdvCheckboxEx3 = () => {
    return (<Row>
      {checkboxData.map(({ id, image, title, percentage, defaultChecked }) => (<Col lg={4} key={id}>
          <Form.Check.Label htmlFor={id} className="check-card">
            <Form.Check.Input id={id} type="checkbox" name="check-card-example3" defaultChecked={defaultChecked}/>
