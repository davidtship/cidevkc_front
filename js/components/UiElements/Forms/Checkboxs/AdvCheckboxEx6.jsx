...
const AdvCheckboxEx6 = () => {
    return (<Row>
      {checkboxData.map(({ id, name, title, company, phone, email, briefcase, website, address, defaultChecked, }) => (<Col lg={4} key={id}>
            <Form.Check.Label htmlFor={id} className="check-card">
              <Form.Check.Input id={id} type="checkbox" name={name} defaultChecked={defaultChecked}/>
