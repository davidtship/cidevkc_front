...
const AdvCheckboxEx1 = () => {
    return (<Row>
      {checkboxData.map(({ id, title, price, priceDesc, desc, defaultChecked }) => (<Col lg={4} key={id}>
          <Form.Check.Label htmlFor={id} className="check-card">
            <Form.Check.Input id={id} type="checkbox" name="check-card-example1" defaultChecked={defaultChecked}/>
