      ...
      <div className="d-grid gap-3 gap-md-4">
          ...
          <Card.Body>
            <Stack direction="horizontal" gap={4}>
              <Stack direction="horizontal" gap={3}>
                <div className="bg-success-subtle text-success border border-success border-opacity-10 rounded hstack justify-content-center" style={{ width: '3rem', height: '3rem' }}>
        ...
        <Card>
          <Card.Body>
            <Stack direction="horizontal" gap={4}>
              <Stack direction="horizontal" gap={3}>
                <div className="bg-danger-subtle text-danger border border-danger border-opacity-10 rounded hstack justify-content-center" style={{ width: '3rem', height: '3rem' }}>
