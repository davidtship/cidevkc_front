...
const LeadOverview = () => {
    const dataLeadOverview = [
        ...
        { label: 'Progress', value: 22.65, change: '-2.2', color: '#222222' },
    ...
    return (<Card>
      ...
      <Card.Body className="mx-auto pt-2">
        <ReactApexChart options={donutChartOptions} series={donutChartOptions.series} type="donut" height={260}/>
        <div className="hstack gap-2 flex-wrap">
          {dataLeadOverview.map((item, index) => (<span key={index} className="p-2 hstack gap-2 flex-fill rounded border border-dashed border-gray-5">
              <span className="rounded-circle d-inline-block" style={{ backgroundColor: item.color, width: '0.5rem', height: '0.5rem' }}></span>
              <span>
                {item.label}
