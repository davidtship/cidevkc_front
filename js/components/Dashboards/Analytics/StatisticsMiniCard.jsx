...
const StatisticsMiniCard = () => {
    return (<>
      <Row className="g-3 g-md-4">
        {columns.map((column, index) => (<Col xl={3} md={6} key={index}>
            <Card>
              <Card.Body className="p-0">
                <Stack direction="horizontal" className="p-4 mb-4 align-items-start">
                  <div>
                    ...
                    <div className="fs-12 text-muted">
                      <i className={`fi ${index % 2 === 0 ? 'fi-rr-arrow-trend-up' : 'fi-rr-arrow-trend-down'} fs-14 ${index % 2 === 0 ? 'text-success' : 'text-danger'}`}></i>
                ...
                <ReactApexChart options={commonChartOptions(column)} series={commonChartOptions(column).series} type="area" height={60}/>
              </Card.Body>
            </Card>
          </Col>))}
      </Row>
