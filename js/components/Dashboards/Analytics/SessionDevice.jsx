          ...
          <Dropdown className="ms-auto" drop="down">
            ...
            <Dropdown.Menu align="end" style={{ marginTop: '0.875rem' }}>
              ...
              <Dropdown.Item>
                ...
                <span className="ms-3">All Channel</span>
              </Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </Card.Header>
        <Card.Body>
          <ReactApexChart options={donutChartOptions} series={donutChartOptions.series} type="donut" height={262}/>
          <Row className="g-3 mt-2">
            {sessionDeviceData.map((item, index) => (<Col key={index} sm={6}>
