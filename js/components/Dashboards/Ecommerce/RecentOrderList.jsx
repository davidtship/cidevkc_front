              ...
              {orders.map((order) => (<tr key={order.id}>
                  ...
                  <td>
                    <div className="hstack">
                      <Avatar size="md" type="image" src={order.customer.image} alt={order.customer.name}/>
                  ...
                  <td>
                    <Stack direction="horizontal" gap={3}>
                      <div className="rounded bg-body-secondary flex-shrink-0" style={{ width: 'max-content' }}>
                        <Image src={order.product.image} fluid rounded className="rounded" style={{ height: '2.5rem' }}/>
                      </div>
                  ...
                  <td>
                    <span className={`badge bg-${order.status.color}-subtle text-${order.status.color}`}>
                      {order.status.text}
                    </span>
                  </td>
