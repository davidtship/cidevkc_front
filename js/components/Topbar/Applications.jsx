    ...
    return (<Dropdown show={dropDownOpen} onToggle={toggleDropDown}>
      ...
      <Dropdown.Menu align="end" className="dropdown-xl py-0 px-0 overflow-hidden">
        <Row className="g-2 p-3">
          {apps.map((app, idx) => {
            return (<Col xs={4} key={idx} className="hstack">
                <Link to="" className="w-100 d-block px-2 py-3 text-center text-decoration-none rounded">
                  <img src={app.img} alt={app.name} width={20} height={20} className="img-fluid rounded-circle"/>
