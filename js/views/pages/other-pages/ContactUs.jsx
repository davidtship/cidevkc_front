...
const ContactUs = () => {
    return (<>
      ...
      <Card>
        <CommonHeader hintText="Get in touch" bigTitle="Contact US" leadDescription="If you'd like to know more about my work or process feel free to get in touch. Either fill out the form with your inquiry or find the department email you'd like to contact below."/>
