...
const Pricing = () => {
    return (<>
      ...
      <Card>
        <CommonHeader hintText="Pricing Plan" bigTitle="Pricing Plan" leadDescription="Compare our plans and find yours. Simple, trasnparent pricing that grow with you. Try any plan free for 30 days."/>
