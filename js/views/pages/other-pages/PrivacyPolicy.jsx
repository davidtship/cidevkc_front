...
const PrivacyPolicy = () => {
    return (<>
      ...
      <Card>
        <CommonHeader hintText="ABOUT THIS POLICY" bigTitle="Privacy & Policy" leadDescription="A privacy policy is a statement or legal document that discloses some or all of the ways a party gathers, uses, discloses, and manages a customer or client's data."/>
