...
const TermsServices = () => {
    return (<>
      ...
      <Card>
        <CommonHeader hintText="Terms of Services" bigTitle="Terms of Services" leadDescription="Terms of service (ToS) is a type of document stating details about what a service provider is responsible for as well as user obligations that must be adhered to for continuation of the service."/>
