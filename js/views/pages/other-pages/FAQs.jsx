...
const FAQs = () => {
    return (<>
      ...
      <Card>
        <CommonHeader hintText="FAQ's" bigTitle="FAQ's" leadDescription="Frequently asked questions. Here are the most frequently asked questions you may check before getting started"/>
