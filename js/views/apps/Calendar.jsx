...
const Calendar = () => {
    ...
    return (<>
      ...
      <Card>
        <Card.Header className="d-flex align-items-center justify-content-between" style={{ height: '5rem' }}>
        ...
        <PerfectScrollbar className="apps-scrollable-content">
          <FullCalendar events={calendarEvents} weekends={true} selectable={true} aspectRatio={3} editable={true} droppable={true} nowIndicator={true} displayEventTime={true} themeSystem="bootstrap5" initialView="dayGridMonth" eventContent={renderEventContent} eventClick={handleEventClick} plugins={[dayGridPlugin, timeGridPlugin, interactionPlugin, listPlugin]} headerToolbar={{
      ...
      <EventDetailModal selectedEvent={selectedEvent} handleCloseModal={handleCloseModals} handleDeleteEvent={handleDeleteEvent} handleUpdateEvent={handleUpdateEvent}/>
      <AddEventModal showModal={showAddEventModal} handleCloseModal={() => setShowAddEventModal(false)} handleAddEvent={handleAddEvent} events={calendarEvents} setEvents={setCalendarEvents} showUpdateEventModal={showUpdateEventModal} setShowUpdateEventModal={setShowUpdateEventModal} selectedEventForEdit={selectedEvent}/>
      <EventUpdateModal show={showUpdateEventModal} handleCloseModal={() => setShowUpdateEventModal(false)} selectedEvent={selectedEvent} handleUpdateEvent={handleUpdateEvent}/>
