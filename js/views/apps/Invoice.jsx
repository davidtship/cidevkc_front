...
const Invoice = () => {
    ...
    return (<>
      ...
      <Card className={`apps-card  ${selectedInvoice ? 'apps-container-toggle' : ''} ${sidebarLeftToggle ? 'apps-sidebar-left-toggle' : ''}`}>
        <div className="apps-sidebar apps-sidebar-left apps-sidebar-md">
          ...
          <InvoiceAsideList invoiceItems={invoiceItems} selectedInvoice={selectedInvoice} setSelectedInvoice={setSelectedInvoice} setShowInvoiceCreate={setShowInvoiceCreate} setLoading={setLoading} searchQuery={searchQuery} onDeleteInvoice={handleDeleteInvoice} setContainerToggle={setContainerToggle}/>
        </div>
        <div className="apps-container">
          <div className="apps-container-inner">
            {loading ? (<Stack className="align-items-center justify-content-center flex-grow-1 h-100 ">
                ...
                {showInvoiceCreateContent ? (<InvoiceCreateContent handleSendClick={handleSendClick} setSelectedInvoice={setSelectedInvoice} setShowInvoiceCreate={setShowInvoiceCreate} sidebarLeftToggle={sidebarLeftToggle} setSidebarLeftToggle={setSidebarLeftToggle}/>) : !selectedInvoice ? (<Stack className="d-none d-lg-flex align-items-center justify-content-center flex-grow-1 h-100 mx-auto text-center" style={{ maxWidth: '320px' }}>
                    ...
                    <InvoiceContentHeader selectedInvoice={selectedInvoice} handleSendClick={handleSendClick} onDeleteInvoice={handleDeleteInvoice} setSelectedInvoice={setSelectedInvoice} setContainerToggle={setContainerToggle} sidebarLeftToggle={sidebarLeftToggle} setSidebarLeftToggle={setSidebarLeftToggle}/>
      ...
      <InvoiceSendOffcanvas showSendOptions={showSendOptions} handleCloseSendOptions={() => setShowSendOptions(false)}/>
    </>);
};
