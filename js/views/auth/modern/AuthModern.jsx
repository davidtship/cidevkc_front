...
const AuthModern = ({ children }) => {
    ...
    return (<>
      <Row className="g-0">
        <Col lg={6} xl={8} className="d-none d-lg-flex bg-primary bg-opacity-25 text-white d-flex flex-column align-items-center justify-content-center position-relative" style={{ minHeight: '100vh', backgroundImage: `url(${dotBg})` }}>
          <video autoPlay loop muted className="position-absolute top-0 left-0 w-100 h-100 object-fit-cover" style={{ zIndex: -1 }}>
            <source src={bgVideo} type="video/mp4"/>
            Your browser does not support the video tag.
          </video>
          <div className="h-100 mx-auto my-12 d-flex flex-column justify-content-between px-4 px-sm-6" style={{ maxWidth: '768px' }}>
            <LogoWhite />
            <div>
        ...
        <Col xs={12} lg={6} xl={4}>
          <Stack className="align-items-center justify-content-center mx-4 mx-sm-6" style={{ minHeight: '100vh' }}>
