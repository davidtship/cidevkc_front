...
const AuthCreative = ({ children }) => {
    ...
    return (<Row className="auth-layout g-0">
      <Col lg={8} xl={9} className="d-none d-lg-flex flex-column align-items-center justify-content-center" style={{ ...creativeBgStyle }}>
        <div className="w-100 h-100 bg-primary bg-opacity-50 text-white">
          <div className="my-12 mx-auto d-flex flex-column justify-content-between px-4 px-sm-6" style={{ maxWidth: '768px', minHeight: 'calc(100vh - 6rem)' }}>
            <LogoWhite />
            <div>
      ...
      <Col xs={12} lg={4} xl={3}>
        <Stack className="align-items-center justify-content-center px-4 px-sm-6 auth-creative-layout" style={{ minHeight: '100vh' }}>
