...
const AuthClassic = ({ children }) => {
    return (<Row className="auth-layout g-0">
      <Col lg={6} className="d-none d-lg-flex text-bg-primary text-white d-flex flex-column align-items-center justify-content-center" style={{ ...BgCircleShapeStyle, minHeight: '100vh' }}>
        <div className="h-100 mx-auto my-12 d-flex flex-column justify-content-between px-4 px-sm-6" style={{ maxWidth: '576px' }}>
          <LogoWhite />
          <div>
