...
const AuthCorporate = ({ children }) => {
    return (<Row className="auth-layout g-0">
      <Col xs={12} lg={6} xl={4}>
      ...
      <Col lg={6} xl={8} className="d-none d-lg-flex flex-column align-items-center justify-content-center bg-primary bg-opacity-10 position-relative" style={{ ...BgCircleShapeStyle, minHeight: '100vh' }}>
        <Image src={fullAvatar} fluid style={{ maxHeight: '100vh' }} className="py-24"/>
        <div className="position-absolute end-10 bottom-10 bg-primary-subtle rounded-3 border border-primary border-opacity-10 p-5 shadow-sm" style={{ maxWidth: '365px' }}>
