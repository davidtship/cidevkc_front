        ...
        <AuthCorporate>
          ...
          <Form onSubmit={handleOTP}>
            ...
            <Stack direction="horizontal" gap={2} className="flex-row justify-content-center mt-2">
              {otp.map((digit, index) => (<input key={index} className="text-center form-control rounded" type="text" maxLength={1} value={digit} onChange={(e) => handleOtpChange(index, e.target.value)} required/>))}
            </Stack>
            ...
            <div className="mt-5 text-muted">
              ...
              {resendCount < 3 && (<a href="javascript:void(0);" onClick={handleResend}>
