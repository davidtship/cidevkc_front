...
const AccountAvatarCover = () => {
  ...
  const avatarImageUploader = React.useRef<HTMLInputElement>(null)
  const coverImageRef = React.useRef<HTMLImageElement>(null)
  const coverImageUploader = React.useRef<HTMLInputElement>(null)

  const handleImageUpload = (
    e: React.ChangeEvent<HTMLInputElement>,
    setImageFile: React.Dispatch<React.SetStateAction<File | null>>,
    imageRef: React.RefObject<HTMLImageElement | null>,
    imageUploader: React.RefObject<HTMLInputElement | null>,
  ) => {
