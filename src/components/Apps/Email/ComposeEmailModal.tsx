          ...
          <Form>
            <Form.Group className="mb-4 position-relative w-100">
              ...
              <Select
                ...
                onChange={(selectedOption: any) => setSelectedToOption(selectedOption)}
            ...
            {isCCVisible && (
              <Form.Group className="mb-4">
                ...
                <Select
                  ...
                  onChange={(selectedOption: any) => setSelectedCCOption(selectedOption)}
            ...
            {isBCCVisible && (
              <Form.Group className="mb-4">
                ...
                <Select
                  ...
                  onChange={(selectedOption: any) => setSelectedBCCOption(selectedOption)}
