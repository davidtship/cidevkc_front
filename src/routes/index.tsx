...
const appsRoutes: RoutesProps = {
  ...
  children: [
    ...
    {
      path: '/ajouter_formulaire',
      name: 'Ajouter_formulaire',
      element: <Ajout_form />,
      route: PrivateRoute,
    },
    {
      path: '/voir_formulaire/:id',
      name: 'Voir_formulaire',
      element: <Voir_form />,
      route: PrivateRoute,
    },
    {
    ...
    },
    {
      path: '/ajout_terminal',
      name: 'Voir_reponses',
      element: <Ajout_terminal />,
      route: PrivateRoute,
    },
    {
      path: '/accuser_reception',
      name: 'Accuser de reception',
      element: <Accuser_reception />,
      route: PrivateRoute,
    },
  ],
}
